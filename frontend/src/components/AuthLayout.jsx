      ...
      <main className={`cv-login-page ${darkMode ? "dark" : ""}`}>
        ...
        <section className="cv-hero" aria-label="ClearVault introduction">
          ...
          <div className="cv-benefits">
            <div className="cv-benefit"><div className="cv-benefit-icon"><FileIcon /></div><div><div className="cv-benefit-title">One digital clearance process</div><div className="cv-benefit-text">Apply once, reach all departments</div></div></div>
        ...
        <div className="cv-auth-actions">
          ...
          <button type="button" className="cv-icon-button" onClick={() => setDarkMode((current) => !current)} aria-label={darkMode ? "Switch to light mode" : "Switch to dark mode"} title={darkMode ? "Switch to light mode" : "Switch to dark mode"}>{darkMode ? <SunIcon /> : <MoonIcon />}</button>
        </div>
