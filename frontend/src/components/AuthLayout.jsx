  ...
  return (
    <>
      ...
      <main className={`cv-login-page ${darkMode ? "dark" : ""}`}>
        ...
        <section className="cv-hero" aria-label="ClearVault introduction">
        ...
        <section className={`cv-auth-card ${darkMode ? "dark" : ""}`}>
          <div className="cv-tabs">
            <NavLink to="/login" className={({ isActive }) => `cv-tab ${isActive ? "active" : ""}`}>
              Sign In
            </NavLink>
            <NavLink to="/register" className={({ isActive }) => `cv-tab ${isActive ? "active" : ""}`}>
              Register
            </NavLink>
            <NavLink to="/forgot-password" className={({ isActive }) => `cv-tab ${isActive ? "active" : ""}`}>
              Forgot Password
            </NavLink>
          </div>
